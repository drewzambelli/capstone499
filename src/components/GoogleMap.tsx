...
interface GoogleMapProps {
  ...
  handleDragStart: () => void; // Added prop for panning start
  handleDragEnd: () => void; // Added prop for panning end

}

const GoogleMap: React.FC<GoogleMapProps> = ({ onDoubleClick, onMarkerClick, setCurrentLocation }) => { // <-- MODIFY THIS
    ...
    if (navigator.geolocation) {
      ...
      navigator.geolocation.getCurrentPosition(
        position => {
          ...
          setUserLocation({ lat, lng }); //{ lat: position.coords.latitude, lng: position.coords.longitude }
